...
<%
	...
	list = boardDao.getBoardLikedList();
%>
<!DOCTYPE html>
<html>
<head>
			...
			<div class="container-fluid">
				<div class="collapse navbar-collapse"
					...
					<ul class="nav navbar-nav">
						...
						<li class="active"><a href="liked_ranking.jsp">좋아요</a></li>
	...
	<div>
		<table class="table">
			...
			<tbody align="center">
				...
				<tr>
					<%if (i == 1) {%>
					<td><img src="./img/Gold Medal.PNG" width="20px;"></td>
					<% i++;} else if (i == 2) { %>
					<td><img src="./img/Silver Medal.PNG" width="20px;"></td>
					<% i++;} else if (i == 3) { %>
					<td><img src="./img/Bronze Medal.PNG" width="20px;"></td>
					<% i++;} else {%>
					<td><%=i++ %></td>
					<%} %>
					<td><%=board.getTitle() %></td>
					<td><%=board.getLiked() %></td>
				</tr>
				<%}
				} else { %>
				<tr>
